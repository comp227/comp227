...
> **Important:**
> This is the older version of the E2E Testing Module,
> and has the same assignments as the previous section on Playwright.
> This is mostly here for historical reasons and for you to see the difference between both frameworks.
...
Please notice that passing the test at this stage *requires that in the backend test database*, there exists a user with the username *`root`* and password *`tigers`*.
